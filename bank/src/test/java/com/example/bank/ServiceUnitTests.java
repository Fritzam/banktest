...
public class ServiceUnitTests {
    ...
    void setUp() {
        ...
        transferService = new TransferService(clientBase, transactionBase);
    ...
    void shouldBeValidTransfer() {
        ...
        boolean isValid = transferService.validTransfer(1, 1000);
    ...
    void shouldNotBeValidTransfer() {
        clientBase.addClient(12000);
        boolean isValid = transferService.validTransfer(1, 13000);
    ...
    void shouldWithdrawA1000() {
        clientBase.addClient(12000);
        transferService.transferMoney(1, 1000);
    ...
    void shouldThrowInsufficientFoundsException() {
        assertThrows(IllegalArgumentException.class, () -> {
           clientBase.addClient(12000);
           transferService.transferMoney(1, 13000);
        });
    }
    ...
    void shouldReturnTransactionReport() {
        clientBase.addClient(12000);
        TransactionReport report = transferService.transferMoney(1, 1000);
    ...
    void shouldAddTo20000() {
        clientBase.addClient(12000);
        TransactionReport final_balance = transferService.addToBalance(1, 8000);
    ...
    void shouldHaveFailedStatus() {
        clientBase.addClient(12000);
        TransactionReport failed_status = transferService.addToBalance(1, -20000);
    ...
    void shouldHaveOKStatus() {
        clientBase.addClient(12000);
        TransactionReport ok_status = transferService.addToBalance(1, 15000);
        assertThat(ok_status.getTransferStatus()).isEqualTo(TransferStatus.OK);
    }
    @Test
    void shouldReturnProperStatus() {
        clientBase.addClient(12000);
        TransactionReport status = transferService.transferMoney(1, 5000);
